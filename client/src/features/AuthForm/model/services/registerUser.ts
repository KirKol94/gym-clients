...
export const fetchRegisterUser = createAsyncThunk<ResponseAuthToken, RegisterData>(
  ...
  async (registerData, thunkApi) => {
    ...
    try {
      ...
      return rejectWithValue('При регистрации возникла ошибка, ' + (error as Error).message)
    }
  },
)
